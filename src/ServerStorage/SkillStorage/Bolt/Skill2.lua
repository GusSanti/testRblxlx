...
local function doHit(mainHitbox, Character, humRP)
	...
	mainHitbox.OnTouch = function(enemyCharacter)
		...
		CombatReplicator.Emit(Character:FindFirstChild('Right Arm'), game.ReplicatedStorage.CombatStorage.Bolt.Effects.HitUpLightning)

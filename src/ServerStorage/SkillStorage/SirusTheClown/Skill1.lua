...
local Assets            = ReplicatedStorage.SkillStorage.SirusTheClown
local Fx                = Assets.FX
...
function module.UseSkill(char: Model)
	...
	hitConnection = RunService.Heartbeat:Connect(function()
		mainHitbox.OnTouch = function(enemyCharacter)
			...
			CombatReplicator.Enable(enemyHumRP, Fx.ChargeEffect, SKILL_CONFIG.StunTime, {C0 = CFrame.new(), C1 = CFrame.new()})

...
local function doHit(mainHitbox, Character, humRP)
	...
	local SlashSFX = Sounds:FindFirstChild("Activate"):Clone()
...
function module.UseSkill(char: Model)
	...
	if not animObj then
		warn("[HitEvent] Animação",animObj.Name,"Não encontrada")
		return
	end
	...
	Weld.C0 = CFrame.new(0, 0, 0.6) * CFrame.Angles(0, math.rad(0), -88)

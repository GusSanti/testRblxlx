...
local EffectStorage = game.ReplicatedStorage.CombatStorage.JunoTheBear.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.JunoTheBear.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.JunoTheBear
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.JunoTheBear.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.JunoTheBear.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.JunoTheBear.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.JunoTheBear.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.JunoTheBear.Skill4,
			Cooldown = 8
		}
	}
}

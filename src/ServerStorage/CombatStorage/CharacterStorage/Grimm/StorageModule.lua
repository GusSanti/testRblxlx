...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Grimm.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Grimm.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Grimm
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Grimm.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Grimm.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Grimm.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Grimm.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Grimm.Skill4,
			Cooldown = 8
		}
	}
}

...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Snapper.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Snapper.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Snapper
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Snapper.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Snapper.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Snapper.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Snapper.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Snapper.Skill4,
			Cooldown = 8
		}
	}
}

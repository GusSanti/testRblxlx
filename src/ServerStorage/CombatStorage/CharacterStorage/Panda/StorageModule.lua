...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Panda.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Panda.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Panda
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Panda.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Panda.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Panda.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Panda.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Panda.Skill4,
			Cooldown = 8
		}
	}
}

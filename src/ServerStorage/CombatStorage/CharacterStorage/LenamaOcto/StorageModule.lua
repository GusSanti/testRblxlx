...
local EffectStorage = game.ReplicatedStorage.CombatStorage.LenamaOcto.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.LenamaOcto.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.LenamaOcto
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.LenamaOcto.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.LenamaOcto.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.LenamaOcto.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.LenamaOcto.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.LenamaOcto.Skill4,
			Cooldown = 8
		}
	}
}

...
local EffectStorage = game.ReplicatedStorage.CombatStorage.IstemiCapy.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.IstemiCapy.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.IstemiCapy
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.IstemiCapy.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.IstemiCapy.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.IstemiCapy.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.IstemiCapy.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.IstemiCapy.Skill4,
			Cooldown = 8
		}
	}
}

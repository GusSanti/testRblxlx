...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Thoosa.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Thoosa.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Thoosa
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Thoosa.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Thoosa.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Thoosa.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Thoosa.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Thoosa.Skill4,
			Cooldown = 8
		}
	}
}

...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Molten.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Molten.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Molten
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Molten.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Molten.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Molten.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Molten.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Molten.Skill4,
			Cooldown = 8
		}
	}
}

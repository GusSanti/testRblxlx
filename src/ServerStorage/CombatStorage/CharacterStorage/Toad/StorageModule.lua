...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Toad.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Toad.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Toad
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Toad.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Toad.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Toad.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Toad.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Toad.Skill4,
			Cooldown = 8
		}
	}
}

...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Bloom.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Bloom.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Bloom
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Bloom.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bloom.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bloom.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bloom.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bloom.Skill4,
			Cooldown = 8
		}
	}
}

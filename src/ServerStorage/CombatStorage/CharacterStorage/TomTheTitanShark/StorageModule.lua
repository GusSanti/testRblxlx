...
local EffectStorage = game.ReplicatedStorage.CombatStorage.TomTheTitanShark.Effects

local AnimationStorage = game.ReplicatedStorage.CombatStorage.GlobalAnimations.CombatAnimationsTemplates.FistUserAnimations
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.TomTheTitanShark.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.TomTheTitanShark
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.TomTheTitanShark.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.TomTheTitanShark.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.TomTheTitanShark.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.TomTheTitanShark.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.TomTheTitanShark.Skill4,
			Cooldown = 8
		}
	}
}

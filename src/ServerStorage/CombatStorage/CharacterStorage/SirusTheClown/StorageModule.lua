...
local EffectStorage = game.ReplicatedStorage.CombatStorage.SirusTheClown.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.SirusTheClown.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.SirusTheClown
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.SirusTheClown.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.SirusTheClown.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.SirusTheClown.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.SirusTheClown.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.SirusTheClown.Skill4,
			Cooldown = 8
		}
	}
}

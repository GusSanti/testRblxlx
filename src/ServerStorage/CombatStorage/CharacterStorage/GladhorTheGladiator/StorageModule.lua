...
local EffectStorage = game.ReplicatedStorage.CombatStorage.GladhorTheGladiator.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.GladhorTheGladiator.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.GladhorTheGladiator
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.GladhorTheGladiator.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.GladhorTheGladiator.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.GladhorTheGladiator.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.GladhorTheGladiator.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.GladhorTheGladiator.Skill4,
			Cooldown = 8
		}
	}
}

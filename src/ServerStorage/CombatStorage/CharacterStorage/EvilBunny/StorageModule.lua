...
local EffectStorage = game.ReplicatedStorage.CombatStorage.EvilBunny.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.EvilBunny.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.EvilBunny
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.EvilBunny.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.EvilBunny.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.EvilBunny.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.EvilBunny.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.EvilBunny.Skill4,
			Cooldown = 8
		}
	}
}

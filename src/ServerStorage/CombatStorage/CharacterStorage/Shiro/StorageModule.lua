...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Shiro.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Shiro.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Shiro
...
module.Logic = {
	BasicInputs = {
		...
		GRAB = {
			...
			GrabInfo = {
				...
				Weld = {
					C0 = CFrame.new(0, 0, 0) * CFrame.Angles(0, math.rad(0), 0),
					C1 = CFrame.new(0, 0, 0) * CFrame.Angles(0, math.rad(0), 0),
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Shiro.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Shiro.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Shiro.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Shiro.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Shiro.Skill4,
			Cooldown = 8
		}
	}
}

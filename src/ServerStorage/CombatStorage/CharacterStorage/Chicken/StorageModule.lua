...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Chicken.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Chicken.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Chicken
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Chicken.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Chicken.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Chicken.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Chicken.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Chicken.Skill4,
			Cooldown = 8
		}
	}
}

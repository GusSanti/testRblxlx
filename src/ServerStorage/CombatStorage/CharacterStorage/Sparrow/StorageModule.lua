...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Sparrow.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Sparrow.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Sparrow
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Sparrow.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Sparrow.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Sparrow.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Sparrow.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Sparrow.Skill4,
			Cooldown = 8
		}
	}
}

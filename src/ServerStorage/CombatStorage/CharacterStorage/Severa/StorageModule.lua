...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Severa.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Severa.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Severa
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Severa.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Severa.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Severa.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Severa.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Severa.Skill4,
			Cooldown = 8
		}
	}
}

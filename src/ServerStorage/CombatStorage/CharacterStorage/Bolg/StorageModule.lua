...
local EffectStorage = game.ReplicatedStorage.CombatStorage.Bolg.Effects
...
local CharacterStorageSFX = game.ReplicatedStorage.CombatStorage.Bolg.Sounds
local ServerStorageFolder = game.ServerStorage.CombatStorage.CharacterStorage.Bolg
		...
		Sequences = {
			LightAtks = {
				[1] = {
					...
					TargetCharacter = 'Self',
					Delay = 0,
					Effect = nil--EffectStorage.SlashLeft
				},
				[2] = {
					Type = 'Emit',
					TargetCharacterBodyPart = 'HumanoidRootPart',
...
module.Logic = {
	...
	Skills = {
		Ultimate = {
			ModuleLocation = SkillStorage.Bolg.Ultimate
		},
		Skill1 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bolg.Skill1,
			Cooldown = 8
		},
		Skill2 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bolg.Skill2,
			Cooldown = 8
		},
		Skill3 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bolg.Skill3,
			Cooldown = 8
		},
		Skill4 = {
			InputType = 'Ended',
			ModuleLocation = SkillStorage.Bolg.Skill4,
			Cooldown = 8
		}
	}
}
